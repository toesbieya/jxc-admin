...
import cn.toesbieya.jxc.document.mapper.SellOrderMapper;
import cn.toesbieya.jxc.document.mapper.SellOrderSubMapper;
...
public class SellOrderService {
    ...
    public Result add(SellOrderVo doc) {
        return addMain(doc);
    }
    ...
    @Lock("#doc.id")
    @Transactional(rollbackFor = Exception.class)
    public Result update(SellOrderVo doc) {
    ...
    @Lock("#doc.id")
    @Transactional(rollbackFor = Exception.class)
    public Result commit(SellOrderVo doc) {
    ...
    private Result addMain(SellOrderVo doc) {
        String err = checkStock(doc.getData());
        if (err != null) return Result.fail(err);

        String id = DocUtil.getDocumentID("XSDD");
    ...
    private Result updateMain(SellOrderVo doc) {
